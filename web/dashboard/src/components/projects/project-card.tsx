...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <div className="bg-accent dark:bg-transparent border border-gray-300 dark:border-opacity-40 rounded-lg w-full h-full p-4">
      <div className="card ">
        <div className="bg-linear-to-r from-accent via-accent/60 to-accent/30 h-36 lg:h-44 rounded-md"></div>
