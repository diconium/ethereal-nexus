...
const PreviewContainer: React.FC<PreviewContainerProps> = ({
  ...
  return (
    <div>
      <div
        className={
          'mt-4 ring-offset-background focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 relative rounded-md border'
        }
      ...
      >
        <div style={{ position: 'absolute', top: '2px', right: '2px' }}>
          ...
          >
            <button className="m-4 p-2 border rounded-sm">
              <ExternalLinkIcon />
            </button>
          </Link>
        </div>
