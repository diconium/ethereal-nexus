      ...
      <Tabs value={tab} defaultValue="components" className="space-y-10">
        <TabsList>
          <TabsTrigger value="components" asChild>
            <Link href={`/projects/${id}?tab=components`}>Components</Link>
          </TabsTrigger>
          <TabsTrigger value="users" asChild>
            <Link href={`/projects/${id}?tab=users`}>Users</Link>
          </TabsTrigger>
          <TabsTrigger value="environments" asChild>
            <Link href={`/projects/${id}?tab=environments`}>Environments</Link>
          </TabsTrigger>
          {hasWritePermissions ? (
            <>
              <TabsTrigger value="settings" asChild>
                <Link href={`/projects/${id}?tab=settings`}>Settings</Link>
              </TabsTrigger>
