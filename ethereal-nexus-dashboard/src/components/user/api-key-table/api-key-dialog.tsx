      ...
      >
        <DialogContent className="gap-0 p-0 px-4 outline-none">
          <DialogHeader className="pb-4 pt-5">
            ...
            <DialogDescription>
              Create a new API Key for your user. The key will be displayed
              here, you should store it, as it will display obfuscated from now
              on.
            </DialogDescription>
          </DialogHeader>
                ...
                render={() => (
                  <FormItem>
                    <div className="mb-4">
                      ...
                      <FormDescription>
                        Select the projects you want to give permissions in the
                        api key.
                      </FormDescription>
                    </div>
