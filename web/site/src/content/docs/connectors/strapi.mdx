...
!["plugin-loaded"](../../../assets/strapi/plugin-loaded.png)
8. Configure the Endpoint and api for your Ethereal Nexus Instance
!["plugin-config"](../../../assets/strapi/configure-plugin.png)
9. Add the component Wrapper to the dynamic zone in your content section
!["add-component"](../../../assets/strapi/add-component.png)

## Example component on author

!["frontend-component"](../../../assets/strapi/frontend-component.png)
