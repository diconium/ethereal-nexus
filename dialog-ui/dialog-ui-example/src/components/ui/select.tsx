...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      {<ChevronDown className="h-4 w-4 opacity-50" /> as React.ReactNode}
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    {<ChevronUp className="h-4 w-4" /> as React.ReactNode}
  </SelectPrimitive.ScrollUpButton>
))
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ...
    {...props}
  >
    {<ChevronDown className="h-4 w-4" /> as React.ReactNode}
  </SelectPrimitive.ScrollDownButton>
))
  ...
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        {<Check className="h-4 w-4" /> as React.ReactNode}
      </SelectPrimitive.ItemIndicator>
    </span>
